  ...
  <table width="900" border="0" cellspacing="0">
    <tr>
      <td height="25" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0">
        <tr>
          <td height="47" align="center" valign="middle" bgcolor="#666666"><span class="texto">NIVEL SECUNDARIA</span></td>
        </tr>
      </table>
        <table width="864" height="25" border="0">
        <tr>
          <td width="653" height="21" align="center" valign="middle"><p><a href="secundaria.php"><img src="../img/BACK.png" width="50" height="37" border=""><br>Volver</a></p>
